...
@section('content')
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-11">
					<div class="card">
						<div class="card-header justify-content-center">{{ '  PROGRAMA SOCIAL |  '}} {!!$programa->programa!!} {{'	|	MÓDULO GOD' }} <i class="fa fa-user-secret"></i></div>
						<div class="card-body">
							  	...
							  	@foreach($total_usuarios as $usuario)
							  		@if($usuario->folio != 0)
									    <tr>
									      ...
									      <th><a href="{{ route('info-personal.edit',$usuario->folio) }}" class="btn btn-info"><i class="fa fa-pencil"></i></span></a>
