...
@section('title','Actualizar Datos Sociodemográficos')
...
@section('content')
	...
	{!! Form::open(['route' => ['info-sociodemo.update',$usuario->folio], 'method' => 'PUT']) !!}

		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-11">
					<div class="card">
						<div class="card-header justify-content-center">{{ '  PROGRAMA SOCIAL |  '}} {!!$programa->programa!!} {{'	|	ACTUALIZAR APARTADO B 	|	DATOS SOCIOECONÓMICOS' }} <i class="fa fa-user-tie"></i></div>
						<div class="card-body">
